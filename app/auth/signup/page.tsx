  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-purple to-black px-4">
      <div className="max-w-md w-full bg-black/80 backdrop-blur-md rounded-lg p-8 border border-cream/20">
        ...
        <p className="text-cream/70 text-center mb-8">Create your account</p>
        ...
        <form onSubmit={handleSignUp} className="space-y-4 mb-6">
          ...
          <div>
            <label htmlFor="confirmPassword" className="block text-sm font-medium text-cream/90 mb-2">
              Confirm Password
            </label>
            <input
              id="confirmPassword"
        ...
        <p className="text-center text-sm text-cream/60">
          ...
          <Link href="/auth/signin" className="text-cream hover:text-cream/80 font-semibold">
            Sign in
          </Link>
        </p>
      </div>
