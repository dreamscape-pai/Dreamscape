                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <p className={`text-sm ${isDaily ? 'text-gray-300' : 'text-gray-600'}`}>
                      {format(new Date(event.startTime), 'h:mma').toLowerCase().replace(':00', '')} - {format(new Date(event.endTime), 'h:mma').toLowerCase().replace(':00', '')}
                    </p>
                    {event.space && (
                      <div className="mt-2">
                ...
                {dayEvents.map((event) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className={isDaily ? 'text-gray-300' : 'text-gray-600'}>{format(new Date(event.startTime), 'h:mma').toLowerCase().replace(':00', '')}</div>
                      {event.space && (
